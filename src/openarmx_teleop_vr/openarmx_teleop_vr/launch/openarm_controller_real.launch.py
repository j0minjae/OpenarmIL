#!/usr/bin/env python3
"""Real robot VR teleoperation using openarm_controller (SoT IK solver).

Uses openarm_ prefix joints directly — no joint_name_remapper needed.

Usage:
  Terminal 1: CAN setup + bringup
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable="openarm_teleop_node",
            name="openarm_teleop_node",
            output="screen",
